...
(function (e, t, s) {
  ...
  if (!e.DUOSHUO) {
    var l, c, u, p, h = e.location, m = e.JSON, f = e.XMLHttpRequest, v = m && m.stringify && e.localStorage,
      ...
      _ = e.navigator.userAgent, y = "https:" == t.location.protocol ? "https:" : "http:", w = 0, k = function () {
        var e = {"<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;"}, t = /&(?!\w+;)|[<>"'`]/g,
          s = /[&<>"'`]/, a = function (t) {
            return e[t] || "&amp;"
          };
      ...
      E = e.DUOSHUO = {
        ...
        getCookie: function (e) {
          for (var a, i, n, r = " " + e + "=", o = t.cookie.split(";"),
                 d = 0; d < o.length; d++)if (a = " " + o[d], i = a.indexOf(r), i >= 0 && i + r.length == (n = a.indexOf("=") + 1))return decodeURIComponent(a.substring(n, a.length).replace(/\+/g, ""));
          return s
        },
        param: function (e) {
          var t = [];
        ...
        for (var i = ["Moz", "Webkit", "ms"], e = e.charAt(0).toUpperCase() + e.substr(1),
               n = 0; n < i.length; n++)if ("string" == typeof a[i[n] + e])return !s || i[n] + e
      }, O = E.selectors = {
    ...
    for (var K = E.templates = {
      ...
      serviceList: function (e) {
        for (var t = '<ul class="ds-service-list">', s = ["weibo", "qq", "renren", "douban"],
               a = 0; a < s.length; a++)t += K.loginItem(s[a], e);
        return t + '<li><a class="ds-more-services" href="javascript:void(0)">更多»</a></li></ul>'
      },
      additionalServices: function (e) {
        for (var t = '<ul class="ds-service-list ds-additional-services">',
               s = ["kaixin", "netease", "sohu", "baidu", "google"], a = 0; a < s.length; a++)t += K.loginItem(s[a], e);
        return t + "</ul>"
      },
    ...
    re.on("queryDefined", function () {
          ...
          if (bubbleOutTimer && fe.owner == s) clearTimeout(bubbleOutTimer), bubbleOutTimer = 0; else {
            ...
            ge = setTimeout(function () {
              ...
              var t = a.offset(), i = e.el.offset(), n = a.innerWidth() / 2,
                r = e.el.innerHeight() - (t.top - i.top) + 6, o = t.left - i.left - 35 + (n > 35 ? 35 : n);
              try {
      ...
      var he = E.Widget = ie.extend({
        ...
        var t = {
          "unread-comments": {
            ...
            title: "系统消息", apiUrl: "/api/users/unreadNotifications", tmpl: function (e) {
      ...
      E.resetNotify = function () {
        ...
        var s, a = e.options, i = de.data, n = [], o = "", d = {thread_id: e.threadId, parent_id: "", nonce: E.nonce};
        ...
        render: function (e) {
          ...
          var i = this, n = i.embedThread, o = n.options, d = function (e) {
            ...
            }, c = i.el = y(K.replybox(n, e)).click(d), u = c.find("form"), p = u.find("input[type=checkbox]")[0],
            h = u.find("a.ds-service-icon, a.ds-service-icon-grey"),
      ...
      bubbleOut = function () {
        ...
        onload: function (t) {
          ...
          i.data = t.thread, a(ue, t.parentPosts || t.relatedPosts), a(pe, t.users), i.el.find("#ds-waiting").remove(), d.like_thread_enabled && (i.meta = new B.Meta(i), i.meta.render().el.appendTo(l)), d.hot_posts && t.hotPosts && t.hotPosts.length && (i.hotPosts = new B.HotPosts(y('<div class="ds-rounded"></div>'), {
            ...
            embedThread: i,
            params: {source: "duoshuo", thread_id: n, max_depth: d.max_depth, order: d.order, limit: d.limit}
