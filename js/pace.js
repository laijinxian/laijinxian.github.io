(function () {
  var t, e, n, r, s, o, i, u, a, c, l, p, h, f, d, g, m, y, v, w, b, k, S, q, L, x, P, T, R, j, E, O, M, A, N, _, F, C,
    U, W, X, D, H, I, z, G, B, J, K, Q = [].slice, V = {}.hasOwnProperty, Y = function (t, e) {
      function n() {
        this.constructor = t
      }
  ...
  for (b = {
    ...
    var t, e, n, r, s, o, i;
    for (e = arguments[0], r = 2 <= arguments.length ? Q.call(arguments, 1) : [], o = 0, i = r.length; o < i; o++)if (n = r[o])for (t in n)V.call(n, t) && (s = n[t], null != e[t] && "object" == typeof e[t] && null != s && "object" == typeof s ? k(e[t], s) : e[t] = s);
    return e
  }, m = function (t) {
    var e, n, r, s, o;
    ...
    return t.prototype.on = function (t, e, n, r) {
      ...
      if (n = arguments[0], t = 2 <= arguments.length ? Q.call(arguments, 1) : [], null != (i = this.bindings) ? i[n] : void 0) {
        for (s = 0, a = []; s < this.bindings[n].length;)u = this.bindings[n][s], r = u.handler, e = u.ctx, o = u.once, r.apply(null != e ? e : this, t), o ? a.push(this.bindings[n].splice(s, 1)) : a.push(s++);
        return a
      }
    }, t
  }(), c = window.Pace || {}, window.Pace = c, k(c, i.prototype), j = c.options = k({}, b, window.paceOptions, q()), B = ["ajax", "document", "eventLag", "elements"], H = 0, z = B.length; H < z; H++)F = B[H], j[F] === !0 && (j[F] = b[F]);
  a = function (t) {
    function e() {
    ...
    if (o = e.type, s = e.request, i = e.url, !N(i))return c.running || j.restartOnRequestAfter === !1 && "force" !== _(o) ? void 0 : (r = arguments, n = j.restartOnRequestAfter || 0, "boolean" == typeof n && (n = 0), setTimeout(function () {
      ...
      if (e = "socket" === o ? s.readyState < 2 : 0 < (u = s.readyState) && u < 4) {
        for (c.restart(), a = c.sources, l = [], n = 0, i = a.length; n < i; n++) {
    ...
    for (a = null != (u = j.extraSources) ? u : [], r = 0, o = a.length; r < o; r++)F = a[r], C.push(new F(j));
    ...
    return c.running = !0, y.render(), t = R(), v = !1, g = M(function (e, n) {
      ...
      for (p = 100 - y.progress, s = g = 0, o = !0, a = m = 0, b = C.length; m < b; a = ++m)for (F = C[a], d = null != A[a] ? A[a] : A[a] = [], u = null != (S = F.elements) ? S : [F], l = w = 0, k = u.length; w < k; l = ++w)i = u[l], f = null != d[l] ? d[l] : d[l] = new h(i), o &= f.done, f.done || (s++, g += f.tick(e));
